...
export const metadata: Metadata = {
  title: 'The Artist Portal — Where Talent Meets Opportunity',
  description: 'Bangladesh\'s premier platform connecting models and artists with agencies and brands.',
}
